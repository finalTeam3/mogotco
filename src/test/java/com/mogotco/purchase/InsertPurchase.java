	...
	void contextLoads() {
		...
		try {
			...
			PurchaseDetailDTO detail = new PurchaseDetailDTO(0,purchase.getMentoringoption_mentoringoptionid(), r, 0, "x", purchase.getPurdate(), 
					...
					mentoring.getMentorurl(), purchase.getMentoring_mplace(),0 , mentoring.getMcaring(), mentoring.getMentorid(),0, mentoring.getMentor_mentorimg());//membercount부분은 member부분에서 저장되기 때문에 굳이 detail에서 넣어줄 이유가 없음
